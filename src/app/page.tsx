    ...
    <main className="mx-auto w-full max-w-2xl px-5 py-16">
      ...
      <section className="mt-14 border-t border-slate-100 pt-8">
        ...
        <p className="mt-4 text-sm leading-relaxed text-ink">
          {pick(
            lang,
            "It is a community resource, not an official one. Field Guide isn't affiliated with or published by any annual conference or by The United Methodist Church — it's built and maintained by an active United Methodist pastor, offered to the connection in that spirit rather than on its behalf. It's a tool for delegates, clergy, and lay members to understand the business before them and talk it through in good faith. Questions, perspectives, and notes come from the community and are reviewed by volunteer stewards — never presented as the conference's own voice.",
